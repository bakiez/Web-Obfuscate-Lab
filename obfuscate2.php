  ...
  <div class="column is-one-quarter">
      ...
      <div class="column auto">
        ...
        <div class="box">
          ...
          <p>Character Obufscation!
          </p><br>
          <h1 class="subtitle">Your Goal</h1>
          <p>Your goal is show me a header with code <br>Example : <code>abcdefg</code>
          </p><br>
          <h1 class="subtitle">Input</h1>
          <p>
          <form action="obfuscate2.php" method="get">
